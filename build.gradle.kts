...
dependencies {
    ...
    implementation("com.raynigon.spring-boot:ecs-logging-access:1.1.3")
    implementation("com.raynigon.spring-boot:ecs-logging-async:1.1.3")
    ...
    // Documentation
    testImplementation("org.springdoc:springdoc-openapi-ui:1.6.11")
